...
(function mobileTapFix() {
  const SELECTORS = 'button, .menu-btn, .back-btn, .gesture-dir-btn, .ch-flip-wrapper, .cs-item, .leaderboard-tab, .char-option, #icon-profile, .main-menu__logout-btn, .toggle';
